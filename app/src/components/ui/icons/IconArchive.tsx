...
export const IconArchive = () => {
  return (
    <svg viewBox="0 0 24 24" className="icon-archive" width="1em" height="1em">
      <g>
        <path
          className="secondary"
          d="M20.77 5a2 2 0 0 1-.02.22l-1.55 14A2 2 0 0 1 17.2 21H6.79a2 2 0 0 1-1.99-1.78l-1.55-14L3.23 5h17.54z"
        />
        <path
          className="primary"
